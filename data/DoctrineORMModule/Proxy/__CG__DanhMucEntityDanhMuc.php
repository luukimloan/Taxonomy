...
namespace DoctrineORMModule\Proxy\__CG__\DanhMuc\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DanhMuc extends \DanhMuc\Entity\DanhMuc implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'id', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'cons', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'cha', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'ten', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'moTa', '' . "\0" . 'DanhMuc\\Entity\\DanhMuc' . "\0" . 'cap');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DanhMuc $proxy) {
